...
function examFailEmail({
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;color:#8ba3c7">Dear <strong style="color:#eef4fc">${escapeHtml(studentName)}</strong>,</p>
    <p style="margin:0 0 16px;color:#8ba3c7">Thank you for completing <strong style="color:${BRAND_BLUE_ACCENT}">${escapeHtml(course)}</strong>. You did not meet the pass mark on this attempt.</p>
    ${table}
