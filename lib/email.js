...
const { otpEmail, examCertificateEmail, examFailEmail, examIntegrityEmail } = require("./email-templates");
...
async function sendExamIntegrityEmail({
  to,
  studentName,
  examTitle,
  courseName,
...
module.exports = {
  sendOtpEmail,
  sendExamCertificateEmail,
  sendExamFailEmail,
  sendExamIntegrityEmail,
  getEmailConfig
};
